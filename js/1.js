            ...
            var draw_4_d4=true,draw_4_d1=1,draw_4_d2=1,draw_4_d3=1,draw_4_d5=1,draw_4_d6=1,draw_4_d7=1,draw_4_d8=1,draw_4_d9=1;
            ...
            function draw_0(){
              if (draw_0_d4==1) {
                ...
                $(".p2_i").css("opacity",0.5);   
                  ...
                  // 背景云
                context.drawImage(draw_2_1,0,0,draw_2_1.width,draw_2_1.height,canvas.width/2-draw_2_1.width/2,canvas.height/2-draw_2_1.height/2,draw_2_1.width,draw_2_1.height);
                ...
                if (draw_0_3f) {
                  ...
                  // 燕麦奶瓶
                  context.drawImage(draw_0_5,0,0,draw_0_5.width,draw_0_5.height,canvas.width/2-draw_0_5.width*0.7/2*draw_0_3c+5+draw_0_3d*1.2,canvas.height/2-draw_0_5.height*0.7/2*draw_0_3c-30,draw_0_5.width*draw_0_3c*0.7,draw_0_5.height*0.7*draw_0_3c);
                  context.restore();
                  // 夹层云
                  context.save();
                ...
                if (draw_0_d7==false&&draw_0_3f) {
                  ...
                  draw_0_3h>3?draw_0_3h=0:draw_0_3h=Math.floor(draw_0_3h * 100) / 100 +0.5;
              ...
              if (draw_0_d7) {
                ...
                // 奶——奶瓶
                context.drawImage(draw_0_2,0,0,640,draw_0_2.height,canvas.width/2-308*draw_0_d4+draw_0_d6*12,canvas.height/2-draw_0_2.height*draw_0_d4/2+50-draw_0_d6,640*draw_0_d4,439*draw_0_d4);
                // 下云
