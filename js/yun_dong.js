            ...
            function draw_0(){
              if (draw_0_d4==1) {
                ...
                if (draw_0_3f) {
                  ...
                  // 燕麦瓶
                  context.drawImage(draw_0_5,0,0,draw_0_5.width,draw_0_5.height,canvas.width/2-draw_0_5.width*0.7/2*draw_0_3c+draw_0_3d*5,canvas.height/2-draw_0_5.height*0.7/2*draw_0_3c-30,draw_0_5.width*draw_0_3c*0.7,draw_0_5.height*0.7*draw_0_3c);
                  context.restore();
                  // 夹层云
                  context.save();
                ...
                if (draw_0_d7==false&&draw_0_3f) {
                  ...
                  if (draw_0_3h%1 == 0&&draw_6_d2>0.1) {
              ...
              if (draw_0_d7) {
                ...
                // 奶——奶瓶
                context.drawImage(draw_0_2,0,0,640,draw_0_2.height,canvas.width/2-308*draw_0_d4+draw_0_d6*8,canvas.height/2-draw_0_2.height*draw_0_d4/2+50-draw_0_d6,640*draw_0_d4,439*draw_0_d4);
                // 下云
